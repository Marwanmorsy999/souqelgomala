...
-- ============================================================
-- Adds the departments defined in src/lib/categorization/taxonomy.ts that
-- had no DB row yet (Spices, Sauces, Canned & Preserved, Bakery & Biscuits).
-- IDs match the taxonomy exactly so the homepage / navigation / products stay
-- synchronized with the D1 categories.
